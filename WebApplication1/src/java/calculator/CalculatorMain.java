...
package calculator;
/********************************************* 
Save this file as CalculatorMain.java 
to compile it use 
...
///////////////////////////  
CalculatorMain(String frameText)//constructor  
{  
super(frameText);  
...
{  
new CalculatorMain("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, CalculatorMain clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, CalculatorMain clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(CalculatorMain.getFormattedText(tempd));}  
...
cl.displayLabel.setText(CalculatorMain.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, CalculatorMain clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(CalculatorMain.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, CalculatorMain clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
